...
| Uncommitted change summary | v0.2.8 GitHub pre-release exists and npm publish is now being completed;`dev/qc/evidence/` is ignored local evidence;`adamchanadam-aps-*.tgz` generated by `npm pack` should not be committed unless Adam explicitly wants to keep a tarball artifact | 2026-05-28 |
