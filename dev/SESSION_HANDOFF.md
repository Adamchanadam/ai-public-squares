...
Last Updated: 2026-05-27 (0.2.2 pre-release published and read back; project remains ⚠️ pre-release)
...
- Public docs / README: `confirmed` (public docs now show published 0.2.2 pre-release boundary;GitHub Pages readback contains `0.2.2`)。
...
- APS user-facing docs (`docs/index.html` + `docs/guides/` + README): `confirmed` (this pass — CLI-first setup, saved config, short-command daily flow, pre-release trial-use boundary, and 0.2.2 published boundary are aligned)。
...
- Reconciled at: 2026-05-27 0.2.2 pre-release publish — release commit, tag, GitHub pre-release, npm publish, registry readback, pre-release boundary, public walkthrough correction, 0.2.2 saved config / short-command hardening, and current-state document fixes recorded;prompt mirror regenerated.
